 ...
 */
const ROLE_LEVELS = {
    ROLE_SUPPLIER: exports.RoleLevel.SUPPLIER,
    ROLE_CACHIER: exports.RoleLevel.CACHIER,
    ROLE_MERCHANT: exports.RoleLevel.MERCHANT,
};
/**
 ...
 */
function getEffectiveRoles(userRoles, context = DEFAULT_CONTEXT) {
 ...
 */
function hasRole(userRoles, role, context = DEFAULT_CONTEXT) {
 ...
 */
function hasAnyRole(userRoles, roles, context = DEFAULT_CONTEXT) {
 ...
 */
function hasAllRoles(userRoles, roles, context = DEFAULT_CONTEXT) {
 ...
 */
function hasContext(userRoles, context) {
 ...
 */
function getUserContexts(userRoles) {
    const contexts = [];
 ...
 */
function hasMinimumRoleLevel(userRoles, minimumLevel, context = DEFAULT_CONTEXT) {
    const effectiveRoles = getEffectiveRoles(userRoles, context);
 ...
 */
function getHighestRoleLevel(userRoles, context = DEFAULT_CONTEXT) {
    const effectiveRoles = getEffectiveRoles(userRoles, context);
 ...
 */
function canPerformAction(userRoles, requiredRoles, context = DEFAULT_CONTEXT, requireAll = false) {
    if (requireAll) {
 ...
 */
function createContextRoleChecker(context) {
    return {
        hasRole: (userRoles, role) => hasRole(userRoles, role, context),
        hasAnyRole: (userRoles, roles) => hasAnyRole(userRoles, roles, context),
        hasAllRoles: (userRoles, roles) => hasAllRoles(userRoles, roles, context),
        hasMinimumLevel: (userRoles, level) => hasMinimumRoleLevel(userRoles, level, context),
        canPerformAction: (userRoles, requiredRoles, requireAll) => canPerformAction(userRoles, requiredRoles, context, requireAll),
    };
}
/**
 * Role-based authorization decorator for methods
 */
function requiresRole(roles, context = DEFAULT_CONTEXT) {
 ...
 */
function hasRoleInformation(obj) {
 ...
 */
function toLegacyRoles(userRoles) {
    const legacyRoles = {};
 ...
 */
const ERoleChecker = createContextRoleChecker(DEFAULT_CONTEXT);
/**
 * Common role combinations for quick checking
 */
const RoleGroups = {
    CASHIER_ROLES: ['ROLE_CACHIER', 'ROLE_MERCHANT'],
    ALL_ROLES: Object.keys(ROLE_HIERARCHY),
};
...
const ReceiptInputSchema = objectType({
...
const ReceiptReturnOrVoidViaPEMInputSchema = objectType({
...
const ReceiptReturnOrVoidWithProofInputSchema = objectType({
    items: arrayType(ReceiptItemSchema).min(1, { message: 'arrayMin1' }),
...
// PEM Status Schema
const PEMStatusSchema = enumType(PEM_STATUS_OPTIONS);
// Activation Request Schema
const ActivationRequestSchema = objectType({
    registration_key: stringType().min(1, { message: 'fieldIsRequired' }),
});
// PEM Status Offline Request Schema
const PEMStatusOfflineRequestSchema = objectType({
...
const CashRegisterCreateSchema = objectType({
...
const PemCreateInputSchema = objectType({
...
exports.CashRegistersAPI = CashRegistersAPI;
...
exports.PemsAPI = PemsAPI;
exports.PointOfSalesAPI = PointOfSalesAPI;
...
exports.VatRateCodeOptions = VatRateCodeOptions;
...
exports.createContextRoleChecker = createContextRoleChecker;
...
exports.getUserContexts = getUserContexts;
exports.hasAllRoles = hasAllRoles;
exports.hasAnyRole = hasAnyRole;
exports.hasContext = hasContext;
exports.hasMinimumRoleLevel = hasMinimumRoleLevel;
exports.hasRole = hasRole;
exports.hasRoleInformation = hasRoleInformation;
exports.loadPlatformAdapters = loadPlatformAdapters;
exports.parseLegacyRoles = parseLegacyRoles;
exports.requiresRole = requiresRole;
exports.toLegacyRoles = toLegacyRoles;
